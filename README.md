...
- 当前线上运行代码为 Git `bd7293d`；迁移 `0015`、Prompt OS v3 模板发布、五服务和健康检查已通过。新工作台提供整理导入零 AI、显式预备 N1–N7、正式生成硬门禁、方形商品卡、拖拽合并/移动/拆分和中文市场配置；真实员工浏览器登录、SKU 预览与 OSS 归档仍需人工 E2E。
