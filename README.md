...
- 当前线上运行代码为 Git `3966773`；迁移 `0012`、模板 seed、五服务、健康检查、真实 multipart 上传、WebP 规范化、TXT 种子、OSS 读回、双图合并、人工商品名/关系保存和 23 节点/9 PromptVersion 准备 smoke 已通过。浏览器原生文件夹选择与真实 ERP 员工登录仍需人工 E2E。
