...
状态：Prompt OS v2 P0 已部署到 2 号云服务器预览环境，入口为该服务器 IP 的 `18083` 端口；2026-07-30 已完成真实 APIMart/OSS、1+8 付费出图、人工审核、本地 ZIP 导出以及完整 2.1.0 系统提示词 smoke。当前入口仍是测试预览，不是面向 100 名员工的正式 HTTPS 发布。
...
- 当前线上版本为 Git `85c61dd`；已完成迁移、模板 seed、五服务运行、健康检查、登录页/React 外壳/上传控件静态读回和 DeepSeek 完整 system 消息 smoke。浏览器真实文件夹选择与真实 ERP 员工登录仍需人工 E2E。
