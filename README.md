...
- 当前线上运行代码为 Git `27a580f`；迁移 `0013`、五服务、健康检查、无文件名上传预览、浏览器原生单/多图与文件夹入口、紧凑商品列表、选择、删除/归档、退出登录和历史保护已通过。ERP 商品查询后的真实图片下载已通过受限应用路径；真实员工浏览器登录、SKU 预览与 OSS 归档仍需人工 E2E。
