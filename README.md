...
- 当前线上运行代码为 Git `241fdcc`；迁移 `0015` 无新增变更，Prompt OS v3 模板发布、五服务、健康检查和公网静态包读回均通过。工作台提供页面常驻导入区、整理导入零 AI、默认 `Shopee / 东南亚通用 / 1:1 / 1K`、大商品卡、卡内排序/跨卡移动、固定侧浮层、多外观身份卡与 1+8 Prompt，以及正式生成自动准备续跑；真实员工浏览器 SKU/OSS、50 商品场景和新一轮付费 1+8 仍需人工验收。
