...
DEEPSEEK_THINKING_ENABLED = env_bool("DEEPSEEK_THINKING_ENABLED", False)
...
PROMPT_OS_SLOT_CONCURRENCY = env_int("PROMPT_OS_SLOT_CONCURRENCY", 3)
PROMPT_PREPARATION_STALE_SECONDS = env_int("PROMPT_PREPARATION_STALE_SECONDS", 300)
...
MAX_ACTIVE_GENERATIONS = env_int("MAX_ACTIVE_GENERATIONS", 32)
GENERATION_PROVIDER_ACTIVE_LIMIT = env_int("GENERATION_PROVIDER_ACTIVE_LIMIT", 500)
GENERATION_USER_ACTIVE_SOFT_LIMIT = env_int("GENERATION_USER_ACTIVE_SOFT_LIMIT", 5)
GENERATION_QUEUE_CANDIDATE_SCAN_LIMIT = env_int("GENERATION_QUEUE_CANDIDATE_SCAN_LIMIT", 200)
