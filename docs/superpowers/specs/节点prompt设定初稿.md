...
> 2026-08-02 已补充 Prompt OS 3.3 生产节点设计。当前生产仍以运行发布版本为准；3.1 只覆盖营销文案契约，3.2 覆盖工作台与多图链路，3.3 合并两者并固定为下一轮 GPT-5.5 推荐执行基线。见 [Prompt OS 3.3 生产节点设计](./2026-08-02-prompt-os-3.3-production-node-design.md)。实施完成并发布前，不得把 3.3.0 写成现有运行能力。
