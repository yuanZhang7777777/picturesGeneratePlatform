...
> 2026-08-02 已补充 Prompt OS 3.2 节点与工作流设计。当前生产仍为 3.0.0；3.1 只覆盖营销文案契约，3.2 进一步固定工作台触发、预备/正式生成、员工错误文案、多图 `target_appearances`、Prompt 变量总线和 GPT-5.5 执行计划。见 [Prompt OS 3.2 节点与工作流设计](./2026-08-02-prompt-os-3.2-node-workflow-design.md)。实施完成并发布前，不得把 3.2.0 写成现有运行能力。
