...
> 2026-08-02 已补充 Prompt OS 4.1 节点与营销生成设计。当前生产仍以运行发布版本为准；3.1–4.0 只保留为历史推演，4.1 作为下一轮 GPT-5.5 唯一执行基线，收口节点输入输出、商品多图外观、五种购买心理文案策略、目标语言文字锁、Style DNA、员工错误脱敏、前端进度和正式生成门禁。见 [Prompt OS 4.1 节点与营销生成设计](./2026-08-02-prompt-os-4.1-node-marketing-design.md)。实施完成并发布前，不得把 4.1.0 写成现有运行能力。
