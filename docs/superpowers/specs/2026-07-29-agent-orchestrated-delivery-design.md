...
日期：2026-07-29
状态：Agent 协作模型继续有效；2026-07-30 起具体产品流程和实现顺序以 `2026-07-30-dual-speed-product-platform-design.md` 与 `../plans/2026-07-30-dual-speed-platform-implementation.md` 为准
...
```text
工作台 → 新建出图项目 → 图片/文件夹或 ERP SKU → 统一商品分组
→ 商品资料与 AI Brief → 商品创作台 → 批量生产队列
→ 审核中心 → 按平台导出
```

- 每张上传图片默认是一个商品分组；图片拖入同一分组即共同产出一套图，分组可标记为同商品参考或多色/多款组合。
