...
- 商品使用紧凑列表行展示缩略图、名称、状态和生成勾选；全选、取消全选、反选均以当前商品集合为准，0 个商品选中时禁止生成。
- 名称在列表直接编辑；多图关系、市场覆盖、身份锁、整套要求和 9 个槽位 Prompt 进入右侧详情抽屉。
...
5. ERP 输入最多 50 个 SKU，只取 SKU、商品名和图片，后续流程与上传一致。
