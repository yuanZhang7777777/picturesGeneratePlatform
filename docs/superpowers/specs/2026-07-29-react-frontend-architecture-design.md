...
日期：2026-07-29
状态：React 技术架构继续有效；2026-07-30 起业务流程、页面状态和审核/导出口径以 `2026-07-30-dual-speed-product-platform-design.md` 为准
...
3. 迁移“上传图片/文件夹”和“ERP SKU”两个并列入口及统一商品确认板；用 dnd-kit 调用现有合并/拆分接口。
