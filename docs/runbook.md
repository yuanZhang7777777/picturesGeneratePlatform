...
- 目的 2：ERP/销售系统全部 API 主机，至少包含 `103.198.125.2` 与 `103.198.125.5`，TCP `16777`、`8077`、`15672`，方向为出站；其中 `103.198.125.5:16777` 是当前出图平台配置的 ERP open login 与 SKU 商品资料查询入口，`103.198.125.2:16777/8077` 是现有日更自动化可达的旧 ERP 入口。
