...
最后更新：2026-08-03
维护者：主 Agent
状态：`lxc/workbench-v4` 已部署 R0-11 中文界面与提示词体验修复；普通员工界面只看中文可编辑内容，Prompt 框显示画面提示词而不是购买任务，营销图兜底会生成目标语言图片文案，选择按钮已移到右下角生成条。Prompt OS 4.1 的完整营销质量、真实 ERP/OSS、新付费 1+8、50 张压力测试和全量历史测试宽门禁收口仍未完成。
